...
* Trigger signatur: Ofte en enkelt hendelse som triggrer en potensiell forandring i tilstand.
...
![Sensor round-trip path tre](img/5.png)
...
SU_F2Last ( Same Unit and First combined with Last) scorer høyest på test effektivitet. Random mix scorer høyest på kostnadseffektivitet. Ingen 2.ordens strategi er mer effektiv enn Rand(10%) strategien, 
